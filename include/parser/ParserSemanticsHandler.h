#ifndef __PARSER_PARSERSEMANTICSHANDLER_H__
#define __PARSER_PARSERSEMANTICSHANDLER_H__
...
namespace s1
{
   ...
   */
  struct ParserSemanticsHandler
  {
    virtual ~ParserSemanticsHandler() {}
...
#endif // __PARSER_PARSERSEMANTICSHANDLER_H__
