...
/**\def S1_RESULT_COMP_BASE
 * \hideinitializer
 * Result component: &lsquo;base&rsquo; errors
 */
#define S1_RESULT_COMP_BASE                     0u
/**\def S1_E_FAILURE
 * \hideinitializer
 * Generic failure.
 */
#define S1_E_FAILURE                            S1_MAKE_ERROR(S1_RESULT_COMP_BASE, 0)
 ...
 * @{ */
/**\def S1_RESULT_COMP_COMPILEROPTIONS
 * \hideinitializer
 * Result component: compiler options
 */
#define S1_RESULT_COMP_COMPILEROPTIONS          1u
/**\def S1_E_INVALID_OPTIMIZATION
 * \hideinitializer
 * The optimization option was invalid.
 */
#define S1_E_INVALID_OPTIMIZATION               S1_MAKE_ERROR(S1_RESULT_COMP_COMPILEROPTIONS, 0)
/** @} */

/**\name Backend-related result codes
 * @{ */
/**\def S1_RESULT_COMP_BACKEND
 * \hideinitializer
 * Result component: backend-related
 */
#define S1_RESULT_COMP_BACKEND                  2u
/**\def S1_E_UNKNOWN_BACKEND
 * \hideinitializer
 * An unknown backend was requested.
 */
#define S1_E_UNKNOWN_BACKEND                    S1_MAKE_ERROR(S1_RESULT_COMP_BACKEND, 0)
/**\def S1_E_GENERATE_FAILED
 * \hideinitializer
 * Program generation failed.
 */
#define S1_E_GENERATE_FAILED                    S1_MAKE_ERROR(S1_RESULT_COMP_BACKEND, 1)
/** @} */

/**\name Program-related result codes
 * @{ */
/**\def S1_RESULT_COMP_PROGRAM
 * \hideinitializer
 * Result component: program-related
 */
#define S1_RESULT_COMP_PROGRAM                  3u
/**\def S1_E_INVALID_FREQUENCY
 * \hideinitializer
 * An invalid input parameter frequency was given.
 */
#define S1_E_INVALID_FREQUENCY                  S1_MAKE_ERROR(S1_RESULT_COMP_PROGRAM, 0)
/**\def S1_E_UNKNOWN_PARAMETER
 * \hideinitializer
 * A program input parameter is not known.
 */
#define S1_E_UNKNOWN_PARAMETER                  S1_MAKE_ERROR(S1_RESULT_COMP_PROGRAM, 1)
/**\def S1_E_INCOMPATIBLE
 * \hideinitializer
 * The requested compatibility level is not supported.
 */
#define S1_E_INCOMPATIBLE                       S1_MAKE_ERROR(S1_RESULT_COMP_PROGRAM, 2)
/** @} */
