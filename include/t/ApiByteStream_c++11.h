...
class ApiByteStreamTestSuiteCXX11 : public CxxTest::TestSuite
{
...
public:
  void testCreateFromCallbackCXX2 (void)
  {
    size_t testDataSize;
    ...
    for (size_t s = 1; s <= testDataSize; s++)
    {
      ...
      TS_ASSERT(S1_ERROR_EQUAL(lib->GetLastError(), E_STREAM_CUSTOM));
