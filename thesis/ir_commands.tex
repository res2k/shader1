...
\newcommand\sOnestseqbox[1]{\framebox[1.2\width][l]{#1}}
\newcommand\sOnestseq[1]{& \sOnestseqbox{#1}}
\newcommand\sObranch[3]{& \mathtt{if}\ #1\mathtt{:}\\& \indent\sOnestseqbox{#2}\\& \mathtt{else:}\\& \indent\sOnestseqbox{#3}}
\newcommand\sOwhile[3]{& \mathtt{while}\ #1/#2\mathtt{:}\\& \indent\sOnestseqbox{#3}}
