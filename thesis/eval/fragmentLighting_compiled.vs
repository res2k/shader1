...
#var float3 v2f.m_normal_B0_ : $vout.ATTR0 : ATTR0 : 0 : 1
#var float3 v2f.i_tmp8_ : $vout.ATTR1 : ATTR1 : 0 : 1
#var float3 v2f.i_tmp17_ : $vout.ATTR2 : ATTR2 : 0 : 1
...
ADD.F result.attrib[1].xyz, -vertex.attrib[0], c[4];
