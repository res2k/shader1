...
#var float3 v2f.i_tmp7_ : $vin.ATTR0 : ATTR0 : 0 : 1
#var float3 v2f.v_N_ : $vin.ATTR1 : ATTR1 : 0 : 1
#var float3 v2f.i_tmp16_ : $vin.ATTR2 : ATTR2 : 0 : 1
...
RSQ.F R0.x, R0.x;
DP3.F R0.w, fragment.attrib[2], fragment.attrib[2];
MUL.F R0.xyz, R0.x, fragment.attrib[0];
RSQ.F R0.w, R0.w;
MAD.F R1.xyz, R0.w, fragment.attrib[2], R0;
DP3.F R0.w, R1, R1;
RSQ.F R0.w, R0.w;
MUL.F R1.xyz, R0.w, R1;
DP3.F R0.w, fragment.attrib[1], R1;
DP3.F R0.x, fragment.attrib[1], R0;
MAX.F R0.w, R0, {0}.x;
MAX.F R1.w, R0.x, {0}.x;
MOV.F R1.xyz, c[1];
MUL.F R0.xyz, R1, c[4];
