...
\hspace*{1cm}\Galt{\Gnt{asdr\_logisch\_oder}{\scriptsize (\ref{asdr_logisch_oder})} \Gor{}\Gnt{asdr\_zuweisung}{\scriptsize (\ref{asdr_zuweisung})} \Gor{}\Gnt{asdr\_ternaer}{\scriptsize (\ref{asdr_ternaer})} }\\
