...
\hspace*{1cm}\Gt{while}\Gspace\Gt{(}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{)}\Gspace\Gnt{schleife\_while\_block}{\scriptsize (\ref{schleife_while_block})} \\
\Gnt{schleife\_while\_block}:\label{schleife_while_block}\\
