...
\hspace*{1cm}\Gnt{asdr\_logisch\_oder}{\scriptsize (\ref{asdr_logisch_oder})} \Gnt{asdr\_ternaer\_suffix}{\scriptsize (\ref{asdr_ternaer_suffix})} \\
\hspace*{1cm}\Gnt{asdr\_logisch\_oder}{\scriptsize (\ref{asdr_logisch_oder})} \Gnt{asdr\_zuweisung\_suffix}{\scriptsize (\ref{asdr_zuweisung_suffix})} \\
...
\hspace*{1cm}\glq\Gt{=}\grq  \Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \\
...
\hspace*{1cm}\Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \Gnt{asdr\_mult\_operanden}{\scriptsize (\ref{asdr_mult_operanden})} \\
\Gnt{asdr\_mult\_operanden}:\label{asdr_mult_operanden}\\
\hspace*{1cm}\glq\Gt{*}\grq  \Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \\
\hspace*{1cm}\glq\Gt{*}\grq  \Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \Gnt{asdr\_mult\_operanden}{\scriptsize (\ref{asdr_mult_operanden})} \\
\hspace*{1cm}\glq\Gt{/}\grq  \Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \\
\hspace*{1cm}\glq\Gt{/}\grq  \Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \Gnt{asdr\_mult\_operanden}{\scriptsize (\ref{asdr_mult_operanden})} \\
\hspace*{1cm}\glq\Gt{\%}\grq  \Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \\
\hspace*{1cm}\glq\Gt{\%}\grq  \Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \Gnt{asdr\_mult\_operanden}{\scriptsize (\ref{asdr_mult_operanden})} \\
...
\hspace*{1cm}\Gnt{asdr\_mult}{\scriptsize (\ref{asdr_mult})} \Gnt{asdr\_add\_operanden}{\scriptsize (\ref{asdr_add_operanden})} \\
\Gnt{asdr\_add\_operanden}:\label{asdr_add_operanden}\\
\hspace*{1cm}\glq\Gt{+}\grq  \Gnt{asdr\_mult}{\scriptsize (\ref{asdr_mult})} \\
\hspace*{1cm}\glq\Gt{+}\grq  \Gnt{asdr\_mult}{\scriptsize (\ref{asdr_mult})} \Gnt{asdr\_add\_operanden}{\scriptsize (\ref{asdr_add_operanden})} \\
\hspace*{1cm}\glq\Gt{-}\grq  \Gnt{asdr\_mult}{\scriptsize (\ref{asdr_mult})} \\
\hspace*{1cm}\glq\Gt{-}\grq  \Gnt{asdr\_mult}{\scriptsize (\ref{asdr_mult})} \Gnt{asdr\_add\_operanden}{\scriptsize (\ref{asdr_add_operanden})} \\
...
\hspace*{1cm}\glq\Gt{?}\grq  \Gnt{ausdruck}{\scriptsize (\ref{ausdruck})}  \glq\Gt{:}\grq  \Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \\
...
\hspace*{1cm}\Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \Gnt{asdr\_gleichheit\_operanden}{\scriptsize (\ref{asdr_gleichheit_operanden})} \\
\Gnt{asdr\_gleichheit\_operanden}:\label{asdr_gleichheit_operanden}\\
\hspace*{1cm}\glq\Gt{!=}\grq  \Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \\
\hspace*{1cm}\glq\Gt{!=}\grq  \Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \Gnt{asdr\_gleichheit\_operanden}{\scriptsize (\ref{asdr_gleichheit_operanden})} \\
\hspace*{1cm}\glq\Gt{==}\grq  \Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \\
\hspace*{1cm}\glq\Gt{==}\grq  \Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \Gnt{asdr\_gleichheit\_operanden}{\scriptsize (\ref{asdr_gleichheit_operanden})} \\
\Gnt{asdr\_vergleich}:\label{asdr_vergleich}\\
\hspace*{1cm}\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \\
\hspace*{1cm}\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \Gnt{asdr\_vergleich\_operanden}{\scriptsize (\ref{asdr_vergleich_operanden})} \\
\Gnt{asdr\_vergleich\_operanden}:\label{asdr_vergleich_operanden}\\
\hspace*{1cm}\glq\Gt{>}\grq  \Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \\
\hspace*{1cm}\glq\Gt{>}\grq  \Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \Gnt{asdr\_vergleich\_operanden}{\scriptsize (\ref{asdr_vergleich_operanden})} \\
\hspace*{1cm}\glq\Gt{>=}\grq  \Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \\
\hspace*{1cm}\glq\Gt{>=}\grq  \Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \Gnt{asdr\_vergleich\_operanden}{\scriptsize (\ref{asdr_vergleich_operanden})} \\
\hspace*{1cm}\glq\Gt{<}\grq  \Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \\
\hspace*{1cm}\glq\Gt{<}\grq  \Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \Gnt{asdr\_vergleich\_operanden}{\scriptsize (\ref{asdr_vergleich_operanden})} \\
...
\hspace*{1cm}\Gnt{asdr\_logisch\_und}{\scriptsize (\ref{asdr_logisch_und})} \Gnt{asdr\_logisch\_oder\_operanden}{\scriptsize (\ref{asdr_logisch_oder_operanden})} \\
\Gnt{asdr\_logisch\_oder\_operanden}:\label{asdr_logisch_oder_operanden}\\
\hspace*{1cm}\glq\Gt{||}\grq  \Gnt{asdr\_logisch\_und}{\scriptsize (\ref{asdr_logisch_und})} \\
\hspace*{1cm}\glq\Gt{||}\grq  \Gnt{asdr\_logisch\_und}{\scriptsize (\ref{asdr_logisch_und})} \Gnt{asdr\_logisch\_oder\_operanden}{\scriptsize (\ref{asdr_logisch_oder_operanden})} \\
\Gnt{asdr\_logisch\_und}:\label{asdr_logisch_und}\\
\hspace*{1cm}\Gnt{asdr\_gleichheit}{\scriptsize (\ref{asdr_gleichheit})} \\
\hspace*{1cm}\Gnt{asdr\_gleichheit}{\scriptsize (\ref{asdr_gleichheit})} \Gnt{asdr\_logisch\_und\_operanden}{\scriptsize (\ref{asdr_logisch_und_operanden})} \\
\Gnt{asdr\_logisch\_und\_operanden}:\label{asdr_logisch_und_operanden}\\
\hspace*{1cm}\glq\Gt{\&\&}\grq  \Gnt{asdr\_gleichheit}{\scriptsize (\ref{asdr_gleichheit})} \\
\hspace*{1cm}\glq\Gt{\&\&}\grq  \Gnt{asdr\_gleichheit}{\scriptsize (\ref{asdr_gleichheit})} \Gnt{asdr\_logisch\_und\_operanden}{\scriptsize (\ref{asdr_logisch_und_operanden})} \\
