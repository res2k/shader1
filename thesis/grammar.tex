...
\hspace*{1cm}\Gnt{dekl\_funktion}{\scriptsize (\ref{dekl_funktion})} \Gspace\Gopt{\Gnt{programm\_statements}{\scriptsize (\ref{programm_statements})} }\\
...
\hspace*{1cm}\Gnt{asdr\_logisch\_oder}{\scriptsize (\ref{asdr_logisch_oder})} \Gspace\Gopt{\Galt{\Gnt{asdr\_ternaer\_suffix}{\scriptsize (\ref{asdr_ternaer_suffix})} \Gor{}\Gnt{asdr\_zuweisung\_suffix}{\scriptsize (\ref{asdr_zuweisung_suffix})} }}\\
...
\hspace*{1cm}\Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \Gspace\Gopt{\Gnt{asdr\_mult\_operanden}{\scriptsize (\ref{asdr_mult_operanden})} }\\
\Gnt{asdr\_mult\_operanden}:\label{asdr_mult_operanden}\\
\hspace*{1cm}\Galt{\Gt{*}\Gor{}\Gt{/}\Gor{}\Gt{\%}}\Gspace\Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \Gspace\Gopt{\Gnt{asdr\_mult\_operanden}{\scriptsize (\ref{asdr_mult_operanden})} }\\
\Gnt{asdr\_add}:\label{asdr_add}\\
\hspace*{1cm}\Gnt{asdr\_mult}{\scriptsize (\ref{asdr_mult})} \Gspace\Gopt{\Gnt{asdr\_add\_operanden}{\scriptsize (\ref{asdr_add_operanden})} }\\
\Gnt{asdr\_add\_operanden}:\label{asdr_add_operanden}\\
\hspace*{1cm}\Galt{\Gt{+}\Gor{}\Gt{-}}\Gspace\Gnt{asdr\_mult}{\scriptsize (\ref{asdr_mult})} \Gspace\Gopt{\Gnt{asdr\_add\_operanden}{\scriptsize (\ref{asdr_add_operanden})} }\\
...
\hspace*{1cm}\Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \Gspace\Gopt{\Gnt{asdr\_gleichheit\_operanden}{\scriptsize (\ref{asdr_gleichheit_operanden})} }\\
\Gnt{asdr\_gleichheit\_operanden}:\label{asdr_gleichheit_operanden}\\
\hspace*{1cm}\Galt{\Gt{!=}\Gor{}\Gt{==}}\Gspace\Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \Gspace\Gopt{\Gnt{asdr\_gleichheit\_operanden}{\scriptsize (\ref{asdr_gleichheit_operanden})} }\\
\Gnt{asdr\_vergleich}:\label{asdr_vergleich}\\
\hspace*{1cm}\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \Gspace\Gopt{\Gnt{asdr\_vergleich\_operanden}{\scriptsize (\ref{asdr_vergleich_operanden})} }\\
\Gnt{asdr\_vergleich\_operanden}:\label{asdr_vergleich_operanden}\\
\hspace*{1cm}\Galt{\Gt{>}\Gor{}\Gt{>=}\Gor{}\Gt{<}\Gor{}\Gt{<=}}\Gspace\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \Gspace\Gopt{\Gnt{asdr\_vergleich\_operanden}{\scriptsize (\ref{asdr_vergleich_operanden})} }\\
...
\hspace*{1cm}\Gnt{asdr\_logisch\_und}{\scriptsize (\ref{asdr_logisch_und})} \Gspace\Gopt{\Gnt{asdr\_logisch\_oder\_operanden}{\scriptsize (\ref{asdr_logisch_oder_operanden})} }\\
\Gnt{asdr\_logisch\_oder\_operanden}:\label{asdr_logisch_oder_operanden}\\
\hspace*{1cm}\Gt{||}\Gspace\Gnt{asdr\_logisch\_und}{\scriptsize (\ref{asdr_logisch_und})} \Gspace\Gopt{\Gnt{asdr\_logisch\_oder\_operanden}{\scriptsize (\ref{asdr_logisch_oder_operanden})} }\\
\Gnt{asdr\_logisch\_und}:\label{asdr_logisch_und}\\
\hspace*{1cm}\Gnt{asdr\_gleichheit}{\scriptsize (\ref{asdr_gleichheit})} \Gspace\Gopt{\Gnt{asdr\_logisch\_und\_operanden}{\scriptsize (\ref{asdr_logisch_und_operanden})} }\\
\Gnt{asdr\_logisch\_und\_operanden}:\label{asdr_logisch_und_operanden}\\
\hspace*{1cm}\Gt{\&\&}\Gspace\Gnt{asdr\_gleichheit}{\scriptsize (\ref{asdr_gleichheit})} \Gspace\Gopt{\Gnt{asdr\_logisch\_und\_operanden}{\scriptsize (\ref{asdr_logisch_und_operanden})} }\\
...
\hspace*{1cm}\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})}\\
\Gnt{typ}:\label{typ}\\
\hspace*{1cm}\Gnt{typ\_basis}{\scriptsize (\ref{typ_basis})} \Gspace\Gopt{\Gnt{typ\_array}{\scriptsize (\ref{typ_array})} }\\
...
\hspace*{1cm}\Gt{[}\Gspace\Gt{]}\Gspace\Gopt{\Gnt{typ\_array}{\scriptsize (\ref{typ_array})} }\\
...
\hspace*{1cm}\Gnt{typ\_funktion}{\scriptsize (\ref{typ_funktion})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})}\Gspace\Gt{(}\Gspace\Gopt{\Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} }\Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
...
\hspace*{1cm}\Gopt{\Gt{in}}\Gspace\Gopt{\Gt{out}}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})}\Gspace\Gopt{\Gt{=}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} }\Gspace\Gopt{\Gt{,}\Gspace\Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} }\\
\Gnt{funktion\_aufruf}:\label{funktion_aufruf}\\
\hspace*{1cm}\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gt{(}\Gspace\Gopt{\Gnt{funktion\_param\_tatsaechl}{\scriptsize (\ref{funktion_param_tatsaechl})} }\Gspace\Gt{)}\\
\Gnt{funktion\_param\_tatsaechl}:\label{funktion_param_tatsaechl}\\
\hspace*{1cm}\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gopt{\Gt{,}\Gspace\Gnt{funktion\_param\_tatsaechl}{\scriptsize (\ref{funktion_param_tatsaechl})} }\\
...
\hspace*{1cm}\Gnt{dekl\_var\_bzch\_init}{\scriptsize (\ref{dekl_var_bzch_init})} \Gspace\Gopt{\Gt{,}\Gspace\Gnt{dekl\_var\_bzch\_init\_liste}{\scriptsize (\ref{dekl_var_bzch_init_liste})} }\\
...
\hspace*{1cm}\Gnt{dekl\_konst\_bzch\_init}{\scriptsize (\ref{dekl_konst_bzch_init})} \Gspace\Gopt{\Gt{,}\Gspace\Gnt{dekl\_konst\_bzch\_init\_liste}{\scriptsize (\ref{dekl_konst_bzch_init_liste})} }\\
...
\hspace*{1cm}\Galt{\Gnt{Letter}{\scriptsize (\ref{Letter})}\Gor{}\Gt{\_}}\Gspace\Gopt{\Gnt{LetterNumberStr}{\scriptsize (\ref{LetterNumberStr})}}\\
\Gnt{LetterNumberStr}:\label{LetterNumberStr}\\
\hspace*{1cm}\Galt{\Gnt{Letter}{\scriptsize (\ref{Letter})}\Gor{}\Gnt{Number}{\scriptsize (\ref{Number})}\Gor{}\Gt{\_}}\Gspace\Gopt{\Gnt{LetterNumberStr}{\scriptsize (\ref{LetterNumberStr})}}\\
...
\hspace*{1cm}\Gt{//}\Gspace\Galt{\Gt{$\backslash$r}\Gor{}\Gt{$\backslash$n}}\\
