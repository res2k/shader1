...
\hspace*{1cm}\Gnt{typ\_definition}{\scriptsize (\ref{typ_definition})}  \glq\Gt{;}\grq \\
\hspace*{1cm}\Gnt{typ\_definition}{\scriptsize (\ref{typ_definition})}  \glq\Gt{;}\grq \Gnt{block}{\scriptsize (\ref{block})} \\
\hspace*{1cm}\Gnt{dekl\_var}{\scriptsize (\ref{dekl_var})}  \glq\Gt{;}\grq \\
...
\hspace*{1cm}\Gnt{kommando}{\scriptsize (\ref{kommando})}  \glq\Gt{;}\grq \\
\hspace*{1cm}\Gnt{kommando}{\scriptsize (\ref{kommando})}  \glq\Gt{;}\grq \Gnt{block}{\scriptsize (\ref{block})} \\
\Gnt{kommando}:\label{kommando}\\
\hspace*{1cm}\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \\
\hspace*{1cm}\glq\Gt{return}\grq \\
\hspace*{1cm}\glq\Gt{return}\grq \Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \\
...
\Gnt{bezeichner\_wert}:\label{bezeichner_wert}\\
\hspace*{1cm}\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \\
\hspace*{1cm}\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \glq\Gt{[}\grq  \Gnt{ausdruck}{\scriptsize (\ref{ausdruck})}  \glq\Gt{]}\grq \\
\hspace*{1cm}\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gnt{attribut\_liste}{\scriptsize (\ref{attribut_liste})} \\
\hspace*{1cm}\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gnt{attribut\_liste}{\scriptsize (\ref{attribut_liste})} \glq\Gt{[}\grq  \Gnt{ausdruck}{\scriptsize (\ref{ausdruck})}  \glq\Gt{]}\grq \\
\hspace*{1cm}\Gnt{attribut}{\scriptsize (\ref{attribut})} \\
\hspace*{1cm}\Gnt{attribut}{\scriptsize (\ref{attribut})} \glq\Gt{[}\grq  \Gnt{ausdruck}{\scriptsize (\ref{ausdruck})}  \glq\Gt{]}\grq \\
\hspace*{1cm}\Gnt{attribut}{\scriptsize (\ref{attribut})} \Gnt{attribut\_liste}{\scriptsize (\ref{attribut_liste})} \\
\hspace*{1cm}\Gnt{attribut}{\scriptsize (\ref{attribut})} \Gnt{attribut\_liste}{\scriptsize (\ref{attribut_liste})} \glq\Gt{[}\grq  \Gnt{ausdruck}{\scriptsize (\ref{ausdruck})}  \glq\Gt{]}\grq \\

Wertebezeichner bezeichnen Werte und können syntaktisch sowohl auf der \emph{linken} Seite
...
\hspace*{1cm}\Gnt{bezeichner\_wert}{\scriptsize (\ref{bezeichner_wert})}  \glq\Gt{=}\grq  \Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \\
\Gnt{ausdruck}:\label{ausdruck}\\
\hspace*{1cm}\Gnt{asdr\_zuweisung}{\scriptsize (\ref{asdr_zuweisung})} \\
\hspace*{1cm}\Gnt{asdr\_wert}{\scriptsize (\ref{asdr_wert})} \\
\Gnt{asdr\_wert}:\label{asdr_wert}\\
...
\hspace*{1cm}\Gnt{bezeichner\_wert}{\scriptsize (\ref{bezeichner_wert})} \\
...
\hspace*{1cm}\Gnt{funktion\_aufruf}{\scriptsize (\ref{funktion_aufruf})} \Gnt{attribut\_liste}{\scriptsize (\ref{attribut_liste})} \\
\hspace*{1cm}\Gnt{NUMERIC}{\scriptsize (\ref{NUMERIC})} \\
\Gnt{attribut\_liste}:\label{attribut_liste}\\
\hspace*{1cm}\glq\Gt{.}\grq  \Gnt{attribut}{\scriptsize (\ref{attribut})} \\
\hspace*{1cm}\glq\Gt{.}\grq  \Gnt{attribut}{\scriptsize (\ref{attribut})} \Gnt{attribut\_liste}{\scriptsize (\ref{attribut_liste})} \\

Ein Zuweisungsausdruck \Gnt{asdr\_zuweisung}{\scriptsize (\ref{asdr_zuweisung})} weist der durch \glq\Gnt{bezeichner\_wert}\grq bezeichneten Variable den Wert des Ausdrucks
...
\hspace*{1cm}\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \glq\Gt{?}\grq  \Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})}  \glq\Gt{:}\grq  \Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \\
...
\hspace*{1cm}\Gnt{asdr\_ternaer}{\scriptsize (\ref{asdr_ternaer})} \glq\Gt{>}\grq  \Gnt{asdr\_vergleich\_ungleich}{\scriptsize (\ref{asdr_vergleich_ungleich})} \\
\hspace*{1cm}\Gnt{asdr\_ternaer}{\scriptsize (\ref{asdr_ternaer})} \glq\Gt{>=}\grq  \Gnt{asdr\_vergleich\_ungleich}{\scriptsize (\ref{asdr_vergleich_ungleich})} \\
\hspace*{1cm}\Gnt{asdr\_ternaer}{\scriptsize (\ref{asdr_ternaer})} \glq\Gt{<}\grq  \Gnt{asdr\_vergleich\_ungleich}{\scriptsize (\ref{asdr_vergleich_ungleich})} \\
\hspace*{1cm}\Gnt{asdr\_ternaer}{\scriptsize (\ref{asdr_ternaer})} \glq\Gt{<=}\grq  \Gnt{asdr\_vergleich\_ungleich}{\scriptsize (\ref{asdr_vergleich_ungleich})} \\
...
\hspace*{1cm}\Gnt{attr\_vektor}{\scriptsize (\ref{attr_vektor})} \\
\hspace*{1cm}\Gnt{attr\_matrix}{\scriptsize (\ref{attr_matrix})} \\
\hspace*{1cm}\Gnt{attr\_array}{\scriptsize (\ref{attr_array})} \\
...
Vektorattribute (\Gnt{attr\_vektor}{\scriptsize (\ref{attr_vektor})}) werden in \ref{Vektorattribute} beschrieben.\\
Matrixattribute (\Gnt{attr\_matrix}{\scriptsize (\ref{attr_matrix})}) werden in \ref{Matrixattribute} beschrieben.\\
Arrayattribute (\Gnt{attr\_array}{\scriptsize (\ref{attr_array})}) werden in \ref{Arrayattribute} beschrieben.\\
...
~\\
\Gnt{attr\_vektor}:\label{attr_vektor}\\
\hspace*{1cm}\Gnt{SWIZZLE\_RGBA}{\scriptsize (\ref{SWIZZLE_RGBA})} \\
\hspace*{1cm}\Gnt{SWIZZLE\_XYZW}{\scriptsize (\ref{SWIZZLE_XYZW})} \\
...
~\\
\Gnt{attr\_matrix}:\label{attr_matrix}\\
\hspace*{1cm}\glq\Gt{row}\grq \\
\hspace*{1cm}\glq\Gt{col}\grq \\
\hspace*{1cm}\glq\Gt{transposed}\grq \\
\hspace*{1cm}\glq\Gt{inverted}\grq \\
...
~\\
\Gnt{attr\_array}:\label{attr_array}\\
\hspace*{1cm}\glq\Gt{length}\grq \\
...
\hspace*{1cm} \Gnt{typ}{\scriptsize (\ref{typ})}  \Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \glq\Gt{=}\grq  \Gnt{asdr\_wert}{\scriptsize (\ref{asdr_wert})} \\
\hspace*{1cm} \Gnt{typ}{\scriptsize (\ref{typ})}  \Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \glq\Gt{=}\grq  \Gnt{asdr\_wert}{\scriptsize (\ref{asdr_wert})} \glq\Gt{,}\grq  \Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \\
...
\hspace*{1cm}\glq\Gt{out}\grq  \Gnt{typ}{\scriptsize (\ref{typ})}  \Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \glq\Gt{=}\grq  \Gnt{asdr\_wert}{\scriptsize (\ref{asdr_wert})} \\
\hspace*{1cm}\glq\Gt{out}\grq  \Gnt{typ}{\scriptsize (\ref{typ})}  \Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \glq\Gt{=}\grq  \Gnt{asdr\_wert}{\scriptsize (\ref{asdr_wert})} \glq\Gt{,}\grq  \Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \\
...
\hspace*{1cm}\glq\Gt{in}\grq  \Gnt{typ}{\scriptsize (\ref{typ})}  \Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \glq\Gt{=}\grq  \Gnt{asdr\_wert}{\scriptsize (\ref{asdr_wert})} \\
\hspace*{1cm}\glq\Gt{in}\grq  \Gnt{typ}{\scriptsize (\ref{typ})}  \Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \glq\Gt{=}\grq  \Gnt{asdr\_wert}{\scriptsize (\ref{asdr_wert})} \glq\Gt{,}\grq  \Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \\
...
\hspace*{1cm}\glq\Gt{in}\grq \glq\Gt{out}\grq  \Gnt{typ}{\scriptsize (\ref{typ})}  \Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \glq\Gt{=}\grq  \Gnt{asdr\_wert}{\scriptsize (\ref{asdr_wert})} \\
\hspace*{1cm}\glq\Gt{in}\grq \glq\Gt{out}\grq  \Gnt{typ}{\scriptsize (\ref{typ})}  \Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \glq\Gt{=}\grq  \Gnt{asdr\_wert}{\scriptsize (\ref{asdr_wert})} \glq\Gt{,}\grq  \Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \\
...
\hspace*{1cm}\Gnt{attribut}{\scriptsize (\ref{attribut})}  \glq\Gt{(}\grq  \glq\Gt{)}\grq \\
\hspace*{1cm}\Gnt{attribut}{\scriptsize (\ref{attribut})}  \glq\Gt{(}\grq \Gnt{funktion\_param\_tatsaechl}{\scriptsize (\ref{funktion_param_tatsaechl})}  \glq\Gt{)}\grq \\
...
\hspace*{1cm}\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \\
\hspace*{1cm}\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \glq\Gt{=}\grq  \Gnt{asdr\_wert}{\scriptsize (\ref{asdr_wert})} \\
...
\hspace*{1cm}\Gnt{Numbers\_Sign}{\scriptsize (\ref{Numbers_Sign})} \\
\hspace*{1cm}\Gnt{Numbers\_Sign}{\scriptsize (\ref{Numbers_Sign})} \Gnt{Num\_Float\_Exp}{\scriptsize (\ref{Num_Float_Exp})} \\
\hspace*{1cm}\Gnt{Numbers\_Sign}{\scriptsize (\ref{Numbers_Sign})} \glq\Gt{.}\grq \\
\hspace*{1cm}\Gnt{Numbers\_Sign}{\scriptsize (\ref{Numbers_Sign})} \glq\Gt{.}\grq \Gnt{Num\_Float\_Exp}{\scriptsize (\ref{Num_Float_Exp})} \\
\hspace*{1cm}\Gnt{Numbers\_Sign}{\scriptsize (\ref{Numbers_Sign})} \Gnt{Numbers\_Frac}{\scriptsize (\ref{Numbers_Frac})} \\
\hspace*{1cm}\Gnt{Numbers\_Sign}{\scriptsize (\ref{Numbers_Sign})} \Gnt{Numbers\_Frac}{\scriptsize (\ref{Numbers_Frac})} \Gnt{Num\_Float\_Exp}{\scriptsize (\ref{Num_Float_Exp})} \\
...
\hspace*{1cm}\glq\Gt{-}\grq  \Gnt{Numbers\_Frac}{\scriptsize (\ref{Numbers_Frac})} \\
\hspace*{1cm}\glq\Gt{-}\grq  \Gnt{Numbers\_Frac}{\scriptsize (\ref{Numbers_Frac})} \Gnt{Num\_Float\_Exp}{\scriptsize (\ref{Num_Float_Exp})} \\
