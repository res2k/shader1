...
\hspace*{1cm}\Gnt{programm\_statements}{\scriptsize (\ref{programm_statements})} \Gspace\Gnt{EOF}{\scriptsize (\ref{EOF})} \\
\Gnt{programm\_statements}:\label{programm_statements}\\
\hspace*{1cm}\Gnt{dekl\_funktion}{\scriptsize (\ref{dekl_funktion})} \\
\hspace*{1cm}\Gnt{dekl\_funktion}{\scriptsize (\ref{dekl_funktion})} \Gspace\Gnt{programm\_statements}{\scriptsize (\ref{programm_statements})} \\
\hspace*{1cm}\Gnt{typ\_definition}{\scriptsize (\ref{typ_definition})} \Gspace\Gt{;}\\
\hspace*{1cm}\Gnt{typ\_definition}{\scriptsize (\ref{typ_definition})} \Gspace\Gt{;}\Gspace\Gnt{programm\_statements}{\scriptsize (\ref{programm_statements})} \\
\hspace*{1cm}\Gnt{dekl\_var}{\scriptsize (\ref{dekl_var})} \Gspace\Gt{;}\\
\hspace*{1cm}\Gnt{dekl\_var}{\scriptsize (\ref{dekl_var})} \Gspace\Gt{;}\Gspace\Gnt{programm\_statements}{\scriptsize (\ref{programm_statements})} \\
\hspace*{1cm}\Gnt{dekl\_konst}{\scriptsize (\ref{dekl_konst})} \Gspace\Gt{;}\\
\hspace*{1cm}\Gnt{dekl\_konst}{\scriptsize (\ref{dekl_konst})} \Gspace\Gt{;}\Gspace\Gnt{programm\_statements}{\scriptsize (\ref{programm_statements})} \\
...
\hspace*{1cm}\Gnt{typ\_definition}{\scriptsize (\ref{typ_definition})} \Gspace\Gnt{block}{\scriptsize (\ref{block})} \\
\hspace*{1cm}\Gnt{dekl\_var}{\scriptsize (\ref{dekl_var})} \Gspace\Gt{;}\\
\hspace*{1cm}\Gnt{dekl\_var}{\scriptsize (\ref{dekl_var})} \Gspace\Gt{;}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \\
\hspace*{1cm}\Gnt{dekl\_konst}{\scriptsize (\ref{dekl_konst})} \Gspace\Gt{;}\\
\hspace*{1cm}\Gnt{dekl\_konst}{\scriptsize (\ref{dekl_konst})} \Gspace\Gt{;}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \\
\hspace*{1cm}\Gnt{kommando}{\scriptsize (\ref{kommando})} \\
\hspace*{1cm}\Gnt{kommando}{\scriptsize (\ref{kommando})} \Gspace\Gnt{block}{\scriptsize (\ref{block})} \\
\Gnt{kommando}:\label{kommando}\\
\hspace*{1cm}\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{;}\\
\hspace*{1cm}\Gt{return}\Gspace\Gt{;}\\
\hspace*{1cm}\Gt{return}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{;}\\
...
\hspace*{1cm}\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
...
\hspace*{1cm}\Gnt{asdr\_logisch\_oder}{\scriptsize (\ref{asdr_logisch_oder})} \Gspace\Gnt{asdr\_ternaer\_suffix}{\scriptsize (\ref{asdr_ternaer_suffix})} \\
\hspace*{1cm}\Gnt{asdr\_logisch\_oder}{\scriptsize (\ref{asdr_logisch_oder})} \Gspace\Gnt{asdr\_zuweisung\_suffix}{\scriptsize (\ref{asdr_zuweisung_suffix})} \\
...
\Gnt{asdr\_zuweisung\_suffix}:\label{asdr_zuweisung_suffix}\\
\hspace*{1cm}\Gt{=}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \\

Ein Zuweisungsausdruck \Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gnt{asdr\_zuweisung\_suffix}{\scriptsize (\ref{asdr_zuweisung_suffix})} weist dem Ausdruck der linken Seite den Wert des Ausdrucks
...
\hspace*{1cm}\Gt{(}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{)}\\
\hspace*{1cm}\Gt{(}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{)}\Gspace\Gnt{attribut\_liste\_oder\_array\_element}{\scriptsize (\ref{attribut_liste_oder_array_element})} \\
\hspace*{1cm}\Gnt{asdr\_konst\_bool}{\scriptsize (\ref{asdr_konst_bool})} \\
\hspace*{1cm}\Gnt{asdr\_konst\_bool}{\scriptsize (\ref{asdr_konst_bool})} \Gspace\Gnt{attribut\_liste\_oder\_array\_element}{\scriptsize (\ref{attribut_liste_oder_array_element})} \\
\hspace*{1cm}\Gnt{funktion\_aufruf}{\scriptsize (\ref{funktion_aufruf})} \\
\hspace*{1cm}\Gnt{funktion\_aufruf}{\scriptsize (\ref{funktion_aufruf})} \Gspace\Gnt{attribut\_liste\_oder\_array\_element}{\scriptsize (\ref{attribut_liste_oder_array_element})} \\
\hspace*{1cm}\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \\
\hspace*{1cm}\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gnt{attribut\_liste\_oder\_array\_element}{\scriptsize (\ref{attribut_liste_oder_array_element})} \\
\hspace*{1cm}\Gnt{NUMERIC}{\scriptsize (\ref{NUMERIC})} \\
\hspace*{1cm}\Gnt{NUMERIC}{\scriptsize (\ref{NUMERIC})} \Gspace\Gnt{attribut\_liste\_oder\_array\_element}{\scriptsize (\ref{attribut_liste_oder_array_element})} \\
\Gnt{attribut\_liste\_oder\_array\_element}:\label{attribut_liste_oder_array_element}\\
\hspace*{1cm}\Gt{.}\Gspace\Gnt{attribut}{\scriptsize (\ref{attribut})} \\
\hspace*{1cm}\Gt{.}\Gspace\Gnt{attribut}{\scriptsize (\ref{attribut})} \Gspace\Gnt{attribut\_liste\_oder\_array\_element}{\scriptsize (\ref{attribut_liste_oder_array_element})} \\
\hspace*{1cm}\Gt{[}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{]}\\
\hspace*{1cm}\Gt{[}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{]}\Gspace\Gnt{attribut\_liste\_oder\_array\_element}{\scriptsize (\ref{attribut_liste_oder_array_element})} \\
...
\hspace*{1cm}\Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \Gspace\Gnt{asdr\_mult\_operanden}{\scriptsize (\ref{asdr_mult_operanden})} \\
\Gnt{asdr\_mult\_operanden}:\label{asdr_mult_operanden}\\
\hspace*{1cm}\Gt{*}\Gspace\Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \\
\hspace*{1cm}\Gt{*}\Gspace\Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \Gspace\Gnt{asdr\_mult\_operanden}{\scriptsize (\ref{asdr_mult_operanden})} \\
\hspace*{1cm}\Gt{/}\Gspace\Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \\
\hspace*{1cm}\Gt{/}\Gspace\Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \Gspace\Gnt{asdr\_mult\_operanden}{\scriptsize (\ref{asdr_mult_operanden})} \\
\hspace*{1cm}\Gt{\%}\Gspace\Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \\
\hspace*{1cm}\Gt{\%}\Gspace\Gnt{asdr\_unaer}{\scriptsize (\ref{asdr_unaer})} \Gspace\Gnt{asdr\_mult\_operanden}{\scriptsize (\ref{asdr_mult_operanden})} \\
...
\hspace*{1cm}\Gnt{asdr\_mult}{\scriptsize (\ref{asdr_mult})} \Gspace\Gnt{asdr\_add\_operanden}{\scriptsize (\ref{asdr_add_operanden})} \\
\Gnt{asdr\_add\_operanden}:\label{asdr_add_operanden}\\
\hspace*{1cm}\Gt{+}\Gspace\Gnt{asdr\_mult}{\scriptsize (\ref{asdr_mult})} \\
\hspace*{1cm}\Gt{+}\Gspace\Gnt{asdr\_mult}{\scriptsize (\ref{asdr_mult})} \Gspace\Gnt{asdr\_add\_operanden}{\scriptsize (\ref{asdr_add_operanden})} \\
\hspace*{1cm}\Gt{-}\Gspace\Gnt{asdr\_mult}{\scriptsize (\ref{asdr_mult})} \\
\hspace*{1cm}\Gt{-}\Gspace\Gnt{asdr\_mult}{\scriptsize (\ref{asdr_mult})} \Gspace\Gnt{asdr\_add\_operanden}{\scriptsize (\ref{asdr_add_operanden})} \\
...
\hspace*{1cm}\Gt{$\sim$}\Gspace\Gnt{asdr\_basis}{\scriptsize (\ref{asdr_basis})} \\
\hspace*{1cm}\Gt{-}\Gspace\Gnt{asdr\_basis}{\scriptsize (\ref{asdr_basis})} \\
\hspace*{1cm}\Gt{!}\Gspace\Gnt{asdr\_basis}{\scriptsize (\ref{asdr_basis})} \\
...
\Gnt{asdr\_ternaer\_suffix}:\label{asdr_ternaer_suffix}\\
...
\hspace*{1cm}\Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \\
\hspace*{1cm}\Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \Gspace\Gnt{asdr\_gleichheit\_operanden}{\scriptsize (\ref{asdr_gleichheit_operanden})} \\
\Gnt{asdr\_gleichheit\_operanden}:\label{asdr_gleichheit_operanden}\\
\hspace*{1cm}\Gt{!=}\Gspace\Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \\
\hspace*{1cm}\Gt{!=}\Gspace\Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \Gspace\Gnt{asdr\_gleichheit\_operanden}{\scriptsize (\ref{asdr_gleichheit_operanden})} \\
\hspace*{1cm}\Gt{==}\Gspace\Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \\
\hspace*{1cm}\Gt{==}\Gspace\Gnt{asdr\_vergleich}{\scriptsize (\ref{asdr_vergleich})} \Gspace\Gnt{asdr\_gleichheit\_operanden}{\scriptsize (\ref{asdr_gleichheit_operanden})} \\
\Gnt{asdr\_vergleich}:\label{asdr_vergleich}\\
\hspace*{1cm}\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \\
\hspace*{1cm}\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \Gspace\Gnt{asdr\_vergleich\_operanden}{\scriptsize (\ref{asdr_vergleich_operanden})} \\
\Gnt{asdr\_vergleich\_operanden}:\label{asdr_vergleich_operanden}\\
\hspace*{1cm}\Gt{>}\Gspace\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \\
\hspace*{1cm}\Gt{>}\Gspace\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \Gspace\Gnt{asdr\_vergleich\_operanden}{\scriptsize (\ref{asdr_vergleich_operanden})} \\
\hspace*{1cm}\Gt{>=}\Gspace\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \\
\hspace*{1cm}\Gt{>=}\Gspace\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \Gspace\Gnt{asdr\_vergleich\_operanden}{\scriptsize (\ref{asdr_vergleich_operanden})} \\
\hspace*{1cm}\Gt{<}\Gspace\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \\
\hspace*{1cm}\Gt{<}\Gspace\Gnt{asdr\_add}{\scriptsize (\ref{asdr_add})} \Gspace\Gnt{asdr\_vergleich\_operanden}{\scriptsize (\ref{asdr_vergleich_operanden})} \\
...
\hspace*{1cm}\Gnt{asdr\_logisch\_und}{\scriptsize (\ref{asdr_logisch_und})} \Gspace\Gnt{asdr\_logisch\_oder\_operanden}{\scriptsize (\ref{asdr_logisch_oder_operanden})} \\
\Gnt{asdr\_logisch\_oder\_operanden}:\label{asdr_logisch_oder_operanden}\\
\hspace*{1cm}\Gt{||}\Gspace\Gnt{asdr\_logisch\_und}{\scriptsize (\ref{asdr_logisch_und})} \\
\hspace*{1cm}\Gt{||}\Gspace\Gnt{asdr\_logisch\_und}{\scriptsize (\ref{asdr_logisch_und})} \Gspace\Gnt{asdr\_logisch\_oder\_operanden}{\scriptsize (\ref{asdr_logisch_oder_operanden})} \\
\Gnt{asdr\_logisch\_und}:\label{asdr_logisch_und}\\
\hspace*{1cm}\Gnt{asdr\_gleichheit}{\scriptsize (\ref{asdr_gleichheit})} \\
\hspace*{1cm}\Gnt{asdr\_gleichheit}{\scriptsize (\ref{asdr_gleichheit})} \Gspace\Gnt{asdr\_logisch\_und\_operanden}{\scriptsize (\ref{asdr_logisch_und_operanden})} \\
\Gnt{asdr\_logisch\_und\_operanden}:\label{asdr_logisch_und_operanden}\\
\hspace*{1cm}\Gt{\&\&}\Gspace\Gnt{asdr\_gleichheit}{\scriptsize (\ref{asdr_gleichheit})} \\
\hspace*{1cm}\Gt{\&\&}\Gspace\Gnt{asdr\_gleichheit}{\scriptsize (\ref{asdr_gleichheit})} \Gspace\Gnt{asdr\_logisch\_und\_operanden}{\scriptsize (\ref{asdr_logisch_und_operanden})} \\
...
\hspace*{1cm}\Gnt{typ\_basis}{\scriptsize (\ref{typ_basis})} \Gspace\Gnt{typ\_array}{\scriptsize (\ref{typ_array})} \\
...
\hspace*{1cm}\Gt{int}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int}\\
\hspace*{1cm}\Gt{float}\\
...
\hspace*{1cm}\Gt{int3}\\
\hspace*{1cm}\Gt{int4}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int1}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int2}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int3}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int4}\\
\Gnt{typ\_vektor\_float}:\label{typ_vektor_float}\\
\hspace*{1cm}\Gt{float1}\\
\hspace*{1cm}\Gt{float2}\\
\hspace*{1cm}\Gt{float3}\\
\hspace*{1cm}\Gt{float4}\\
...
\hspace*{1cm}\Gt{float1x1}\\
\hspace*{1cm}\Gt{float2x1}\\
\hspace*{1cm}\Gt{float3x1}\\
\hspace*{1cm}\Gt{float4x1}\\
\hspace*{1cm}\Gt{float1x2}\\
\hspace*{1cm}\Gt{float2x2}\\
\hspace*{1cm}\Gt{float3x2}\\
\hspace*{1cm}\Gt{float4x2}\\
\hspace*{1cm}\Gt{float1x3}\\
\hspace*{1cm}\Gt{float2x3}\\
\hspace*{1cm}\Gt{float3x3}\\
\hspace*{1cm}\Gt{float4x3}\\
\hspace*{1cm}\Gt{float1x4}\\
\hspace*{1cm}\Gt{float2x4}\\
\hspace*{1cm}\Gt{float3x4}\\
\hspace*{1cm}\Gt{float4x4}\\
\Gnt{typ\_matrix\_int}:\label{typ_matrix_int}\\
\hspace*{1cm}\Gt{int1x1}\\
\hspace*{1cm}\Gt{int2x1}\\
\hspace*{1cm}\Gt{int3x1}\\
\hspace*{1cm}\Gt{int4x1}\\
\hspace*{1cm}\Gt{int1x2}\\
\hspace*{1cm}\Gt{int2x2}\\
\hspace*{1cm}\Gt{int3x2}\\
\hspace*{1cm}\Gt{int4x2}\\
\hspace*{1cm}\Gt{int1x3}\\
\hspace*{1cm}\Gt{int2x3}\\
\hspace*{1cm}\Gt{int3x3}\\
\hspace*{1cm}\Gt{int4x3}\\
\hspace*{1cm}\Gt{int1x4}\\
\hspace*{1cm}\Gt{int2x4}\\
\hspace*{1cm}\Gt{int3x4}\\
\hspace*{1cm}\Gt{int4x4}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int1x1}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int2x1}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int3x1}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int4x1}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int1x2}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int2x2}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int3x2}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int4x2}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int1x3}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int2x3}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int3x3}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int4x3}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int1x4}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int2x4}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int3x4}\\
\hspace*{1cm}\Gt{unsigned}\Gspace\Gt{int4x4}\\
\Gnt{typ\_matrix\_bool}:\label{typ_matrix_bool}\\
\hspace*{1cm}\Gt{bool1x1}\\
\hspace*{1cm}\Gt{bool2x1}\\
\hspace*{1cm}\Gt{bool3x1}\\
\hspace*{1cm}\Gt{bool4x1}\\
\hspace*{1cm}\Gt{bool1x2}\\
\hspace*{1cm}\Gt{bool2x2}\\
\hspace*{1cm}\Gt{bool3x2}\\
\hspace*{1cm}\Gt{bool4x2}\\
\hspace*{1cm}\Gt{bool1x3}\\
\hspace*{1cm}\Gt{bool2x3}\\
\hspace*{1cm}\Gt{bool3x3}\\
\hspace*{1cm}\Gt{bool4x3}\\
\hspace*{1cm}\Gt{bool1x4}\\
\hspace*{1cm}\Gt{bool2x4}\\
\hspace*{1cm}\Gt{bool3x4}\\
\hspace*{1cm}\Gt{bool4x4}\\
...
\hspace*{1cm}\Gt{sampler1D}\\
\hspace*{1cm}\Gt{sampler2D}\\
\hspace*{1cm}\Gt{sampler3D}\\
\hspace*{1cm}\Gt{samplerCUBE}\\
...
\hspace*{1cm}\Gt{[}\Gspace\Gt{]}\\
\hspace*{1cm}\Gt{[}\Gspace\Gt{]}\Gspace\Gnt{typ\_array}{\scriptsize (\ref{typ_array})} \\
...
\hspace*{1cm}\Gnt{typ\_funktion}{\scriptsize (\ref{typ_funktion})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{(}\Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
\hspace*{1cm}\Gnt{typ\_funktion}{\scriptsize (\ref{typ_funktion})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{(}\Gspace\Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
...
\hspace*{1cm}\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \\
\hspace*{1cm}\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{,}\Gspace\Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \\
\hspace*{1cm}\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{=}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \\
\hspace*{1cm}\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{=}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{,}\Gspace\Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \\
\hspace*{1cm}\Gt{out}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \\
\hspace*{1cm}\Gt{out}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{,}\Gspace\Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \\
\hspace*{1cm}\Gt{out}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{=}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \\
\hspace*{1cm}\Gt{out}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{=}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{,}\Gspace\Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \\
\hspace*{1cm}\Gt{in}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \\
\hspace*{1cm}\Gt{in}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{,}\Gspace\Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \\
\hspace*{1cm}\Gt{in}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{=}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \\
\hspace*{1cm}\Gt{in}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{=}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{,}\Gspace\Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \\
\hspace*{1cm}\Gt{in}\Gspace\Gt{out}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \\
\hspace*{1cm}\Gt{in}\Gspace\Gt{out}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{,}\Gspace\Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \\
\hspace*{1cm}\Gt{in}\Gspace\Gt{out}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{=}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \\
\hspace*{1cm}\Gt{in}\Gspace\Gt{out}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{BEZEICHNER}{\scriptsize (\ref{BEZEICHNER})} \Gspace\Gt{=}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{,}\Gspace\Gnt{funktion\_param\_formal}{\scriptsize (\ref{funktion_param_formal})} \\
\Gnt{funktion\_aufruf}:\label{funktion_aufruf}\\
\hspace*{1cm}\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gt{(}\Gspace\Gt{)}\\
\hspace*{1cm}\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gt{(}\Gspace\Gnt{funktion\_param\_tatsaechl}{\scriptsize (\ref{funktion_param_tatsaechl})} \Gspace\Gt{)}\\
\Gnt{funktion\_param\_tatsaechl}:\label{funktion_param_tatsaechl}\\
\hspace*{1cm}\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \\
\hspace*{1cm}\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{,}\Gspace\Gnt{funktion\_param\_tatsaechl}{\scriptsize (\ref{funktion_param_tatsaechl})} \\
...
Die Sichtbarkeit des Funktionsbezeichners beginnt hinter dem \Gt{)} von \Gnt{dekl\_funktion}{\scriptsize (\ref{dekl_funktion})}
...
\hspace*{1cm}\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{dekl\_var\_bzch\_init\_liste}{\scriptsize (\ref{dekl_var_bzch_init_liste})} \\
...
\hspace*{1cm}\Gnt{dekl\_var\_bzch\_init}{\scriptsize (\ref{dekl_var_bzch_init})} \Gspace\Gt{,}\Gspace\Gnt{dekl\_var\_bzch\_init\_liste}{\scriptsize (\ref{dekl_var_bzch_init_liste})} \\
...
\hspace*{1cm}\Gt{const}\Gspace\Gnt{typ}{\scriptsize (\ref{typ})} \Gspace\Gnt{dekl\_konst\_bzch\_init\_liste}{\scriptsize (\ref{dekl_konst_bzch_init_liste})} \\
...
\hspace*{1cm}\Gnt{dekl\_konst\_bzch\_init}{\scriptsize (\ref{dekl_konst_bzch_init})} \Gspace\Gt{,}\Gspace\Gnt{dekl\_konst\_bzch\_init\_liste}{\scriptsize (\ref{dekl_konst_bzch_init_liste})} \\
...
\hspace*{1cm}\Gt{if}\Gspace\Gt{(}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
\hspace*{1cm}\Gt{if}\Gspace\Gt{(}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\Gspace\Gt{else}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
...
\hspace*{1cm}\Gt{for}\Gspace\Gt{(}\Gspace\Gt{;}\Gspace\Gt{;}\Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
\hspace*{1cm}\Gt{for}\Gspace\Gt{(}\Gspace\Gt{;}\Gspace\Gt{;}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
\hspace*{1cm}\Gt{for}\Gspace\Gt{(}\Gspace\Gt{;}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{;}\Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
\hspace*{1cm}\Gt{for}\Gspace\Gt{(}\Gspace\Gt{;}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{;}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
\hspace*{1cm}\Gt{for}\Gspace\Gt{(}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{;}\Gspace\Gt{;}\Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
\hspace*{1cm}\Gt{for}\Gspace\Gt{(}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{;}\Gspace\Gt{;}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
\hspace*{1cm}\Gt{for}\Gspace\Gt{(}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{;}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{;}\Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
\hspace*{1cm}\Gt{for}\Gspace\Gt{(}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{;}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{;}\Gspace\Gnt{ausdruck}{\scriptsize (\ref{ausdruck})} \Gspace\Gt{)}\Gspace\Gt{\{}\Gspace\Gnt{block}{\scriptsize (\ref{block})} \Gspace\Gt{\}}\\
...
\hspace*{1cm}\Gnt{Comp\_XYZW}{\scriptsize (\ref{Comp_XYZW})} \Gspace\Gnt{Comp\_XYZW}{\scriptsize (\ref{Comp_XYZW})} \\
\hspace*{1cm}\Gnt{Comp\_XYZW}{\scriptsize (\ref{Comp_XYZW})} \Gspace\Gnt{Comp\_XYZW}{\scriptsize (\ref{Comp_XYZW})} \Gspace\Gnt{Comp\_XYZW}{\scriptsize (\ref{Comp_XYZW})} \\
\hspace*{1cm}\Gnt{Comp\_XYZW}{\scriptsize (\ref{Comp_XYZW})} \Gspace\Gnt{Comp\_XYZW}{\scriptsize (\ref{Comp_XYZW})} \Gspace\Gnt{Comp\_XYZW}{\scriptsize (\ref{Comp_XYZW})} \Gspace\Gnt{Comp\_XYZW}{\scriptsize (\ref{Comp_XYZW})} \\
\Gnt{SWIZZLE\_RGBA}:\label{SWIZZLE_RGBA}\\
\hspace*{1cm}\Gnt{Comp\_RGBA}{\scriptsize (\ref{Comp_RGBA})} \\
\hspace*{1cm}\Gnt{Comp\_RGBA}{\scriptsize (\ref{Comp_RGBA})} \Gspace\Gnt{Comp\_RGBA}{\scriptsize (\ref{Comp_RGBA})} \\
\hspace*{1cm}\Gnt{Comp\_RGBA}{\scriptsize (\ref{Comp_RGBA})} \Gspace\Gnt{Comp\_RGBA}{\scriptsize (\ref{Comp_RGBA})} \Gspace\Gnt{Comp\_RGBA}{\scriptsize (\ref{Comp_RGBA})} \\
\hspace*{1cm}\Gnt{Comp\_RGBA}{\scriptsize (\ref{Comp_RGBA})} \Gspace\Gnt{Comp\_RGBA}{\scriptsize (\ref{Comp_RGBA})} \Gspace\Gnt{Comp\_RGBA}{\scriptsize (\ref{Comp_RGBA})} \Gspace\Gnt{Comp\_RGBA}{\scriptsize (\ref{Comp_RGBA})} \\
\Gnt{BEZEICHNER}:\label{BEZEICHNER}\\
\hspace*{1cm}\Gnt{Letter}{\scriptsize (\ref{Letter})} \\
\hspace*{1cm}\Gnt{Letter}{\scriptsize (\ref{Letter})} \Gspace\Gnt{LetterNumberStr}{\scriptsize (\ref{LetterNumberStr})} \\
\hspace*{1cm}\Gt{\_}\\
\hspace*{1cm}\Gt{\_}\Gspace\Gnt{LetterNumberStr}{\scriptsize (\ref{LetterNumberStr})} \\
\Gnt{LetterNumberStr}:\label{LetterNumberStr}\\
\hspace*{1cm}\Gnt{Letter}{\scriptsize (\ref{Letter})} \\
\hspace*{1cm}\Gnt{Letter}{\scriptsize (\ref{Letter})} \Gspace\Gnt{LetterNumberStr}{\scriptsize (\ref{LetterNumberStr})} \\
\hspace*{1cm}\Gnt{Number}{\scriptsize (\ref{Number})} \\
\hspace*{1cm}\Gnt{Number}{\scriptsize (\ref{Number})} \Gspace\Gnt{LetterNumberStr}{\scriptsize (\ref{LetterNumberStr})} \\
\hspace*{1cm}\Gt{\_}\\
\hspace*{1cm}\Gt{\_}\Gspace\Gnt{LetterNumberStr}{\scriptsize (\ref{LetterNumberStr})} \\
...
\hspace*{1cm}\Gnt{Whitespace}{\scriptsize (\ref{Whitespace})} \Gspace\Gnt{WS}{\scriptsize (\ref{WS})} \\
...
\hspace*{1cm}\Gnt{Number}{\scriptsize (\ref{Number})} \\
\hspace*{1cm}\Gnt{Number}{\scriptsize (\ref{Number})} \Gspace\Gnt{Numbers}{\scriptsize (\ref{Numbers})} \\
...
\hspace*{1cm}\Gt{e}\Gspace\Gnt{Numbers\_Sign}{\scriptsize (\ref{Numbers_Sign})} \\
\hspace*{1cm}\Gt{E}\Gspace\Gnt{Numbers\_Sign}{\scriptsize (\ref{Numbers_Sign})} \\
\Gnt{Num\_Float}:\label{Num_Float}\\
\hspace*{1cm}\Gnt{Numbers}{\scriptsize (\ref{Numbers})} \\
\hspace*{1cm}\Gnt{Numbers}{\scriptsize (\ref{Numbers})} \Gspace\Gnt{Num\_Float\_Exp}{\scriptsize (\ref{Num_Float_Exp})} \\
\hspace*{1cm}\Gnt{Numbers}{\scriptsize (\ref{Numbers})} \Gspace\Gt{.}\\
\hspace*{1cm}\Gnt{Numbers}{\scriptsize (\ref{Numbers})} \Gspace\Gt{.}\Gspace\Gnt{Num\_Float\_Exp}{\scriptsize (\ref{Num_Float_Exp})} \\
\hspace*{1cm}\Gnt{Numbers}{\scriptsize (\ref{Numbers})} \Gspace\Gnt{Numbers\_Frac}{\scriptsize (\ref{Numbers_Frac})} \\
\hspace*{1cm}\Gnt{Numbers}{\scriptsize (\ref{Numbers})} \Gspace\Gnt{Numbers\_Frac}{\scriptsize (\ref{Numbers_Frac})} \Gspace\Gnt{Num\_Float\_Exp}{\scriptsize (\ref{Num_Float_Exp})} \\
\hspace*{1cm}\Gnt{Numbers\_Frac}{\scriptsize (\ref{Numbers_Frac})} \\
\hspace*{1cm}\Gnt{Numbers\_Frac}{\scriptsize (\ref{Numbers_Frac})} \Gspace\Gnt{Num\_Float\_Exp}{\scriptsize (\ref{Num_Float_Exp})} \\
\Gnt{Digit\_Hex}:\label{Digit_Hex}\\
\hspace*{1cm}\Grange{0}{9}\\
\hspace*{1cm}\Grange{A}{F}\\
\hspace*{1cm}\Grange{a}{f}\\
\Gnt{Digits\_Hex}:\label{Digits_Hex}\\
\hspace*{1cm}\Gnt{Digit\_Hex}{\scriptsize (\ref{Digit_Hex})} \\
\hspace*{1cm}\Gnt{Digit\_Hex}{\scriptsize (\ref{Digit_Hex})} \Gspace\Gnt{Digits\_Hex}{\scriptsize (\ref{Digits_Hex})} \\
...
\hspace*{1cm}\Gt{//}\Gspace\Gt{$\backslash$r}\\
\hspace*{1cm}\Gt{//}\Gspace\Gt{$\backslash$n}\\
