...
\subsection{{Eintrittsfunktion}}\label{__Eintrittsfunktion__}
...
\section{Ausdrücke}\label{Ausdruecke}
...
\subsection{Zuweisung}\label{Zuweisung}
...
\subsection{Basisausdruck}\label{Basisausdruck}
...
\subsubsection{Zuweisungskompatibilität}\label{Zuweisungskompatibilitaet}
...
\subsection{Binäre Ausdrücke}\label{Binaere Ausdruecke}
...
\subsubsection{Arithmetische Operatoren}\label{Arithmetische Operatoren}
~\\
...
\subsection{Unäre Ausdrücke}\label{Unaere Ausdruecke}
...
\subsection{Ternärer Ausdruck}\label{Ternaerer Ausdruck}
...
\subsection{Boole'sche Werte}\label{Boole'sche Werte}
...
\subsection{Boole'scher Typ}\label{Boole'scher Typ}
...
\subsection{Vektortypen}\label{Vektortypen}
...
\subsubsection{Vektorkonstruktoren}\label{Vektorkonstruktoren}
...
\subsubsection{Vektorattribute}\label{Vektorattribute}
...
\subsection{Matrixtypen}\label{Matrixtypen}
...
\subsubsection{Matrixkonstruktoren}\label{Matrixkonstruktoren}
...
\subsubsection{Matrixattribute}\label{Matrixattribute}
...
\subsection{Samplertypen}\label{Samplertypen}
...
\subsection{Arraytypen}\label{Arraytypen}
...
\subsubsection{Arraykonstruktoren}\label{Arraykonstruktoren}
...
\subsubsection{Arrayattribute}\label{Arrayattribute}
...
\subsection{Typdefinitionen}\label{Typdefinitionen}
...
\subsection{Typumwandlung}\label{Typumwandlung}

\subsubsection{{Implizite Typumwandlungen}}\label{__Implizite Typumwandlungen__}
...
\subsubsection{{Explizite Typumwandlungen}}\label{__Explizite Typumwandlungen__}
...
\subsection{Aufruf}\label{Aufruf}
...
\subsection{Überladene Funktionen}\label{Ueberladene Funktionen}
...
\section{Konstanten und Variablen}\label{Konstanten und Variablen}
\subsection{Variablendeklarationen}\label{Variablendeklarationen}
...
\subsection{Konstantendeklarationen}\label{Konstantendeklarationen}
...
\subsection{\kw{for}-Schleifen}\label{$_backslash$kw__for__-Schleifen}
...
\subsection{\kw{while}-Schleifen}\label{$_backslash$kw__while__-Schleifen}
...
\section{Lexikalische Einheiten}\label{Lexikalische Einheiten}
...
\subsection{Bezeichner}\label{Bezeichner}
...
\subsection{Numerische Literale}\label{Numerische Literale}
...
\hspace*{1cm}\Galt{\Gnt{Digits\_Dec}{\scriptsize (\ref{Digits_Dec})}\Gspace\Gopt{\Galt{\Gt{.}\Gor{}\Gnt{Digits\_Dec\_Frac}{\scriptsize (\ref{Digits_Dec_Frac})}}}\Gor{}\Gnt{Digits\_Dec\_Frac}{\scriptsize (\ref{Digits_Dec_Frac})}}\Gspace\Gopt{\Gnt{Num\_Float\_Exp}{\scriptsize (\ref{Num_Float_Exp})}}\\
