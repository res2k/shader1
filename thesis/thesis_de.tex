...
Algorithmen zur Kantenglättung benutzt werden. Zum Verständnis reicht es jedoch aus, anzunehmen, dass ein Fragment einem Pixel entspricht.} zu 
...
Die Entscheidung wird für individuelle Sequenzoperationen getroffen. Jeder Operation lässt sich eine \emph{Berechnungsfrequenz}, % TODO: Verw auf Frequenzen
...
Programme der Shadingsprache sind grundsätzlich so formuliert, als würden Operationen per Fragment ausgeführt. % Ref Formulierte Frequenz
