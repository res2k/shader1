...
Da eine eigene ID insgesamt 20 weitere IDs pro Typ -- wobei später noch jeder ID wiederum die ursprünglichen Werte für $N$ und $M$ nochmals zugeordnet
werden müssen -- prüft der Lexer, ob ein Bezeichner den angegebenen Muster für Vektor- bzw. Matrixschlüsselwörtern entspricht. Ist dies der Fall,
so wird dies im generierten Token vermerkt; weiterhin werden bereits $N$ bzw. $M$ aus den Bezeichnern extrahiert und ebenfalls vermerkt. % 
