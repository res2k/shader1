...
\begin{defn}
\emphalt{Transformationen} sind Abbildungen von Raumkoordinaten auf Raumkoordinaten und dienen dazu,
...
\begin{defn}
Die Eingaben der Ausgaben der Vertexberechnungen werden aus den der Vertexberechnung durch \emphalt{lineare Interpolation}
abgeleitet.
...
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/simple.cg}}

\prglisting{lst:example_s1}{Eingabeprogramm für den Compiler in der Shadingsprache}
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/simple.s1}}

\prglisting{lst:example_compiled}{Ausgabe des Compilers in Cg}
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/simple_compiled.cg}}
...
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/C5E2v_fragmentLighting.cg}}

\prglisting{lst:fraglight_cg_fp}{Beleuchtungsberechnung im Pixelprogramm: Pixelprogramm}
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/C5E3f_basicLight.cg}}
...
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/fragmentLighting.s1}}

\prglisting{lst:fraglight_compiled}{Ausgabe des Compilers in Cg}
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/fragmentLighting_compiled.cg}}
...
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/C5E1v_basicLight.cg}}

\prglisting{lst:vertlight_cg_fp}{Beleuchtungsberechnung für jedes Vertex: Pixelprogramm}
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/C2E2f_passthru.cg}}
...
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/basicLight.s1}}
...
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/basicLight_compiled.cg}}
...
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/C5E4v_twoLights.cg}}
...
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/twoLights.s1}}
...
{\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left,breaklines]{eval/twoLights_compiled.cg}}
