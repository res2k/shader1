...
\begin{defn}
Die Eingaben der Pixelberechnungen werden aus den Ausgaben der Vertexberechnungen durch \emphalt{lineare Interpolation}
abgeleitet.
...
\begin{figure}[h]
  \centering
  (a) \includegraphics[width=5cm]{mesh_wireframe_thin}\qquad
  (b) \includegraphics[width=5cm]{simple_s1_mesh}\\
  (c) \includegraphics[width=5cm]{simple_s1_vert}\qquad
  (d) \includegraphics[width=5cm]{simple_s1_frag}
...
\begin{figure}[h]
  \centering
  (a) \includegraphics[width=5cm]{simple_s1_crop_large_wire}\qquad
  (b) \includegraphics[width=5cm]{simple_s1_crop_large_mesh}\\
  (c) \includegraphics[width=5cm]{simple_s1_crop_large_vert}\qquad
  (d) \includegraphics[width=5cm]{simple_s1_crop_large_frag}
...
\begin{figure}[ht]
  ...
  \centering
  \small Markierung der Operationen bzw. Werte gibt an, mit welcher Frequenz diese ausgeführt bzw. berechnet wurden.
