...
\sOfuncregset{float}{\sOsetreg{i\_tmp2}\sOsetreg{i\_tmp4}\sOsetreg{i\_tmp6}\sOsetreg{i\_tmp8}}
...
\sOfuncregset{unsigned\ int}{\sOsetreg{i\_tmp1}\sOsetreg{i\_tmp3}\sOsetreg{i\_tmp5}\sOsetreg{i\_tmp7}}
\sOfuncbody{
...
\sOstatement{\sOreg{i\_tmp2} &\gets \sOcast{\sOreg{i\_tmp1}}{float}}
\sOstatement{\sOreg{i\_tmp3} &\gets \sOconst{0}}
\sOstatement{\sOreg{i\_tmp4} &\gets \sOcast{\sOreg{i\_tmp3}}{float}}
\sOstatement{\sOreg{i\_tmp5} &\gets \sOconst{0}}
\sOstatement{\sOreg{i\_tmp6} &\gets \sOcast{\sOreg{i\_tmp5}}{float}}
\sOstatement{\sOreg{i\_tmp7} &\gets \sOconst{1}}
\sOstatement{\sOreg{i\_tmp8} &\gets \sOcast{\sOreg{i\_tmp7}}{float}}
\sOstatement{\sOreg{m\_outColor\_B0} &\gets \sOmakevec{\sOreg{i\_tmp2}, \sOreg{i\_tmp4}, \sOreg{i\_tmp6}, \sOreg{i\_tmp8}}}
}
}
