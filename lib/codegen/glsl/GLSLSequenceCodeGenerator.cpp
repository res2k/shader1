    ...
    namespace glsl
    {
                                                               ...
                                                               const RegisterPtr& source2)
      {
        ...
        if ((op == ArithmeticOp::Mul)
            && (source1->GetOriginalType ()->GetTypeClass () == semantics::Type::Matrix)
            && (source2->GetOriginalType ()->GetTypeClass () == semantics::Type::Matrix))
        {
                                                                 ...
                                                                 const RegisterPtr& source2)
      {
        ...
        if (source1->GetOriginalType ()->GetTypeClass () == semantics::Type::Vector)
        {
