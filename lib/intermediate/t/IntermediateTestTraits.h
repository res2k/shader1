...
CXXTEST_ENUM_TRAITS (TestSequenceVisitor::Operation,
                     ...
                     CXXTEST_ENUM_MEMBER (TestSequenceVisitor::opSampleTexture1D)
                     CXXTEST_ENUM_MEMBER (TestSequenceVisitor::opSampleTexture2D)
                     CXXTEST_ENUM_MEMBER (TestSequenceVisitor::opSampleTexture3D)
                     CXXTEST_ENUM_MEMBER (TestSequenceVisitor::opSampleTextureCUBE)
