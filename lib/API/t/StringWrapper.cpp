...
BOOST_AUTO_TEST_CASE(Empty)
{
  ...
  BOOST_CHECK_EQUAL (std::char_traits<char>::length (empty.GetUTF8 ()), 0u);
  BOOST_CHECK_EQUAL_CH (empty.GetUTF8 ()[0], 0);
  BOOST_CHECK_EQUAL (std::char_traits<char16_t>::length (empty.GetUTF16 ()), 0u);
  BOOST_CHECK_EQUAL_CH (empty.GetUTF16 ()[0], 0);
  BOOST_CHECK_EQUAL (std::char_traits<char32_t>::length (empty.GetUTF32 ()), 0u);
  BOOST_CHECK_EQUAL_CH (empty.GetUTF32 ()[0], 0);
  BOOST_CHECK_EQUAL (std::char_traits<wchar_t>::length (empty.GetWCS ()), 0u);
...
BOOST_AUTO_TEST_CASE(Ascii)
{
  ...
  BOOST_CHECK_EQUAL (std::char_traits<char>::length (hello.GetUTF8 ()), 5u);
  ...
  BOOST_CHECK_EQUAL (std::char_traits<char16_t>::length (hello.GetUTF16 ()), 5u);
  ...
  BOOST_CHECK_EQUAL (std::char_traits<char32_t>::length (hello.GetUTF32 ()), 5u);
  ...
  BOOST_CHECK_EQUAL (std::char_traits<wchar_t>::length (hello.GetWCS ()), 5u);
...
BOOST_AUTO_TEST_CASE(Unicode1)
{
  ...
  BOOST_CHECK_EQUAL (std::char_traits<char>::length (hello.GetUTF8 ()), 6u);
  BOOST_CHECK_EQUAL_CH (hello.GetUTF8 ()[0], 'H');
...
BOOST_AUTO_TEST_CASE(Unicode2)
{
  ...
  BOOST_CHECK_EQUAL (std::char_traits<char>::length (monkey.GetUTF8 ()), 4u);
  ...
  BOOST_CHECK_EQUAL (std::char_traits<char16_t>::length (monkey.GetUTF16 ()), 2u);
  ...
  BOOST_CHECK_EQUAL (std::char_traits<char32_t>::length (monkey.GetUTF32 ()), 1u);
