...
class DynamicTlsTestSuite : public CxxTest::TestSuite 
{
public:
  ...
  void testStress()
  {
    ...
    TS_ASSERT_EQUALS(correctValues.load(), handleCount);
  ...
  void testUseAfterFree ()
  {
    ...
    TS_ASSERT_DIFFERS(retrievedValue, &tlsHandle);
    TS_ASSERT_EQUALS(retrievedValue, nullptr);
  }
};
