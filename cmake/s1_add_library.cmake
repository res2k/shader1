...
# "Internal" library: Library that will be merged into an 'external' library later
...
# "External" library: Library eventually shipped to a user
function(s1_add_library_external TARGET)
  CMAKE_PARSE_ARGUMENTS(S1_LIB
                        "STATIC;SHARED"
                        ""
                        "SOURCES;DEPENDS;LINK"
                        ${ARGN})
  IF(S1_LIB_UNPARSED_ARGS)
    MESSAGE(FATAL_ERROR "Unexpected arguments to s1_add_library_external: ${S1_LIB_UNPARSED_ARGS}")
  ENDIF()
  if((S1_LIB_STATIC AND S1_LIB_SHARED) OR (NOT S1_LIB_STATIC AND NOT S1_LIB_SHARED))
    MESSAGE(FATAL_ERROR "s1_add_library_external requires one of STATIC or SHARED")
  endif()
  S1_GET_DEPENDENCIES(DEPS_OBJ DEPS_LINK DEPS_TARGETS ${S1_LIB_LINK})
  if(S1_LIB_STATIC)
